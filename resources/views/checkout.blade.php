    ...
    <main class="pt-32 pb-20 px-6 max-w-7xl mx-auto">
        <div class="flex flex-col lg:flex-row gap-12">
                    ...
                    <div class="space-y-12">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-2">
                                    ...
                                    <input type="text" name="customer_name" value="{{ Auth::user()->name ?? old('customer_name') }}" required
                                        class="w-full bg-white border border-stone-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-stone-900 transition-all">
                                </div>
                                <div class="space-y-2">
                        ...
                        <section x-data="{ paymentMethod: 'credit_card' }">
                            ...
                            <div class="bg-white rounded-3xl border border-stone-200 overflow-hidden shadow-sm">
                                ...
                                <div class="p-8 border-b border-stone-100" x-data="{ editingAddress: {{ Auth::user() && Auth::user()->address_line1 ? 'false' : 'true' }} }">
                                    ...
                                    @if(Auth::user() && Auth::user()->address_line1)
                                        ...
                                        <div x-show="!editingAddress" class="p-5 bg-stone-50 rounded-2xl border border-stone-200">
                                            <div class="flex items-start gap-4">
                                                <div class="w-10 h-10 rounded-xl bg-white border border-stone-200 flex items-center justify-center text-stone-400">
                                    ...
                                    <div x-show="editingAddress" x-transition class="space-y-6 mt-6">
                                        <div class="space-y-2">
                                            ...
                                            <input type="text" name="address_line1" value="{{ Auth::user()->address_line1 ?? old('address_line1') }}" required
                                                class="w-full bg-stone-50/50 border border-stone-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-stone-900 transition-all">
                                        </div>
                                        ...
                                        <div class="grid grid-cols-2 gap-6">
                                            ...
                                            <div class="space-y-2">
                                                ...
                                                <select name="country" class="w-full bg-stone-50/50 border border-stone-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-stone-900 transition-all">
                                    ...
                                    <!-- Billing Toggle -->
                                    <div class="mt-8 pt-8 border-t border-stone-100" x-data="{ billingSame: true }">
                                        ...
                                        <div x-show="billingSame" class="p-4 bg-emerald-50/50 border border-emerald-100 rounded-xl flex items-center gap-3">
                                        ...
                                        <div x-show="!billingSame" x-transition class="space-y-4 mt-4">
                                            <input type="text" placeholder="Billing Street Address" class="w-full bg-stone-50/50 border border-stone-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-stone-900 transition-all">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="p-8 bg-stone-50/30">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                                        <label class="relative flex flex-col p-4 bg-white border rounded-2xl cursor-pointer transition-all hover:border-stone-900"
                                            :class="paymentMethod === 'credit_card' ? 'border-stone-900 ring-1 ring-stone-900 shadow-md' : 'border-stone-200'">
                                        ...
                                        <label class="relative flex flex-col p-4 bg-white border rounded-2xl cursor-pointer transition-all hover:border-stone-900"
                                            :class="paymentMethod === 'cod' ? 'border-stone-900 ring-1 ring-stone-900 shadow-md' : 'border-stone-200'">
                                        ...
                                        <label class="relative flex flex-col p-4 bg-white border rounded-2xl cursor-pointer transition-all hover:border-stone-900"
                                            :class="paymentMethod === 'bank_transfer' ? 'border-stone-900 ring-1 ring-stone-900 shadow-md' : 'border-stone-200'">
                                    ...
                                    <div x-show="paymentMethod === 'credit_card'" x-transition class="space-y-4">
                                        <div class="space-y-2">
                                            ...
                                            <div class="relative">
                                                <input type="text" placeholder="0000 0000 0000 0000" class="w-full bg-white border border-stone-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-stone-900 transition-all">
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            <div class="space-y-2">
                                                ...
                                                <input type="text" placeholder="MM / YY" class="w-full bg-white border border-stone-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-stone-900 transition-all">
                                            </div>
                                            <div class="space-y-2">
                                                <label class="text-[10px] font-black text-stone-400 uppercase tracking-widest">CVC / CVV</label>
                                                <input type="text" placeholder="123" class="w-full bg-white border border-stone-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-stone-900 transition-all">
                                            </div>
                                        </div>
                                    </div>
                                    
                                    <div x-show="paymentMethod === 'cod'" x-transition class="p-6 bg-stone-100 rounded-2xl text-center border border-stone-200">
                        ...
                        <section>
                            ...
                            <textarea name="notes" placeholder="Delivery instructions, gift messages, etc."
                                class="w-full bg-white border border-stone-200 rounded-2xl px-6 py-4 text-sm focus:outline-none focus:border-stone-900 transition-all h-32"></textarea>
                        </section>
                    </div>
                </form>
            </div>
            ...
            <div class="lg:w-[400px]">
                <div class="bg-white rounded-3xl border border-stone-200 p-8 sticky top-32 shadow-xl shadow-stone-200/50">
                    ...
                    <div class="space-y-4 border-t border-stone-100 pt-6 mb-8">
                        ...
                        <div class="flex justify-between items-center border-t border-stone-100 pt-4 mt-4">
