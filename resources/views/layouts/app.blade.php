...
<head>
    ...
    <body class="antialiased font-sans text-gray-900 bg-white" x-data="{ scrolled: false, mobileMenuOpen: false, isDarkPage: {{ (request()->is('/') || request()->is('gallery*') || request()->is('account*') || request()->is('cart*')) ? 'true' : 'false' }} }" @scroll.window="scrolled = (window.pageYOffset > 50)">
            ...
            <div class="flex items-center justify-between h-16 lg:h-20">
              <a
                ...
                <div class="hidden sm:block">
                  <span
                    ...
                    :class="(!isDarkPage || scrolled) ? 'text-gray-900' : 'text-white'"
                    >NEXSTYLE</span
                  ><span
                    class="block text-xs tracking-widest transition-colors"
                    :class="(!isDarkPage || scrolled) ? 'text-gray-500' : 'text-white/70'"
                    >FASHION &amp; TECH</span
                  >
                </div></a
              >
              <nav class="hidden md:flex items-center gap-8">
                <a
                  ...
                  :class="(!isDarkPage || scrolled) ? 'text-gray-900 {{ request()->is('/') ? 'border-gray-900' : 'border-transparent' }}' : 'text-white {{ request()->is('/') ? 'border-white' : 'border-transparent' }}'"
                  href="{{ url('/') }}"
                  data-discover="true"
                  >Home</a
                ><a
                  ...
                  :class="(!isDarkPage || scrolled) ? 'text-gray-900 {{ request()->is('gallery') ? 'border-gray-900' : 'border-transparent' }}' : 'text-white {{ request()->is('gallery') ? 'border-white' : 'border-transparent' }}'"
                  href="{{ url('/gallery') }}"
                  data-discover="true"
                  >Gallery</a
                ><a
                  ...
                  :class="(!isDarkPage || scrolled) ? 'text-gray-900 {{ request('category') === 'fashion' ? 'border-gray-900' : 'border-transparent' }}' : 'text-white {{ request('category') === 'fashion' ? 'border-white' : 'border-transparent' }}'"
                ...
                ><a
                  ...
                  :class="(!isDarkPage || scrolled) ? 'text-gray-900 {{ request('category') === 'tech' ? 'border-gray-900' : 'border-transparent' }}' : 'text-white {{ request('category') === 'tech' ? 'border-white' : 'border-transparent' }}'"
                ...
                <div class="hidden md:flex items-center gap-4">
                    <a
                        ...
                        :class="(!isDarkPage || scrolled) ? 'text-gray-600 hover:text-gray-900' : 'text-white/80 hover:text-white'"
                        href="{{ url('/gallery') }}"
                        data-discover="true"
                    ...
                    <a
                        ...
                        :class="(!isDarkPage || scrolled) ? 'bg-stone-900 text-white hover:bg-stone-800' : 'bg-white/15 text-white hover:bg-white/25 border border-white/30'"
                        href="{{ route('login') }}"
                        data-discover="true"
                    ...
                    <div class="relative flex items-center" x-data="{ open: false }" @click.away="open = false">
                        ...
                        >
                            ...
                            <span class="text-sm font-medium transition-colors" :class="(!isDarkPage || scrolled) ? 'text-stone-900' : 'text-white'">
                                {{ Auth::user()->email }}
                            </span>
                            <i class="ri-arrow-down-s-line text-lg transition-transform" :class="[open ? 'rotate-180' : '', (!isDarkPage || scrolled) ? 'text-stone-400' : 'text-white/60']"></i>
                        </button>
