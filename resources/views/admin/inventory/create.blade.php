                ...
                <div class="bg-white p-8 rounded-xl border border-stone-100 shadow-sm space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="name" required value="{{ old('name') }}" placeholder="e.g. Obsidian Structured Blazer"
                        ...
                        <div>
                            ...
                            <input type="text" name="brand" value="{{ old('brand') }}" placeholder="e.g. MAISON NOIR"
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="6" placeholder="Write a detailed product description..."
                            class="w-full bg-stone-50 border border-stone-300 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-amber-500 transition-colors resize-none">{{ old('description') }}</textarea>
                    </div>
                </div>
                                    ...
                                    <div class="flex-1 space-y-3">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <input type="text" name="additional_images[]" placeholder="https://..."
                                            ...
                                            <div>
                                                <label class="block text-[10px] font-bold text-stone-500 mb-1">Or Upload</label>
            ...
            <div class="space-y-8">
                ...
                <div class="bg-white p-8 rounded-xl border border-stone-100 shadow-sm space-y-6">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="original_price" placeholder="0.00 (Optional)"
                        ...
                        <p class="text-[10px] text-stone-500 mt-1 italic">Used for showing discount % and Sale badge</p>
                    </div>
                ...
                <div class="pt-4">
                    <button type="submit" class="w-full bg-stone-900 text-white py-4 rounded-xl font-bold hover:bg-stone-800 transition-all shadow-xl shadow-stone-200 flex items-center justify-center gap-2">
                        <i class="ri-save-line text-lg"></i> Save Product to Inventory
                    </button>
                    <a href="{{ route('admin.inventory.index') }}" class="block text-center mt-4 text-xs font-bold text-stone-500 hover:text-stone-900 uppercase tracking-widest transition-colors">Discard Changes</a>
                </div>
            </div>
        </div>
    </form>
